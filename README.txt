...
This is the readme for PROJECT, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. PROJECT) > Ok.
...
- To run the project find PROJECT.java (which will be in under src/main/java/project) and right click > Run 'PROJECT'
